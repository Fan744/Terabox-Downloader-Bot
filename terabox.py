...
API_ID = os.environ.get('TELEGRAM_API', ''30157302)
if len(API_ID) == 0:
    logging.error("TELEGRAM_API variable is missing! Exiting now")
    exit(1)

API_HASH = os.environ.get('TELEGRAM_HASH', '0052039fb2fca727868d0228cdaad569')
if len(API_HASH) == 0:
    logging.error("TELEGRAM_HASH variable is missing! Exiting now")
    exit(1)
    
BOT_TOKEN = os.environ.get('BOT_TOKEN', '8158540124:AAFGXiQYxNHgCWpISBMzoH_4UoFcWM1ZszE')
if len(BOT_TOKEN) == 0:
    logging.error("BOT_TOKEN variable is missing! Exiting now")
    exit(1)

DUMP_CHAT_ID = os.environ.get('DUMP_CHAT_ID', '-1003376672755')
...
FSUB_ID = os.environ.get('FSUB_ID', '-1003407124877')
if len(FSUB_ID) == 0:
...
USER_SESSION_STRING = os.environ.get('USER_SESSION_STRING', '1BVtsOHABuyzQLQepmoOH34J53Ff54EYtfoeY8F7uboHhDdJYqT1pnCMC7Zi68VzuolicVIm6Wt77eWv-XyUe_txgRbstVb15n0-s7IbN_FCKlc39EoW3-a52YeqiCPuJ09c3HhYiTL_XsxGKiKQmqLO0-OWNGoLgACwp__JV1dX4Fa3FAUteFOcIaTE4DQvCaF6B2vHrDuxuxMmCiUWC9XMqPNoehXKpQEPlefD3MQ8twLGeGmBGYzpKz5xM-34rcCidEkW0i0w9pEn1WWJH8CsniFTXZoi5at3A4iraZjCGT2HlFtqFcy_vjNk_8aSYGpq_YR5JXvmJb9Wx-tcSzbvI_80lHuE=')
